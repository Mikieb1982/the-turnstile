...
export const mockLeagueTable: LeagueStanding[] = [
    ...
    { rank: 3, teamId: TEAMS.catalans.id, teamName: TEAMS.catalans.name, teamLogoUrl: TEAMS.catalans.logoUrl, played: 14, wins: 10, draws: 0, losses: 4, points: 20, form: 'LWWWW' },
    { rank: 4, teamId: TEAMS.warrington.id, teamName: TEAMS.warrington.name, teamLogoUrl: TEAMS.warrington.logoUrl, played: 14, wins: 9, draws: 0, losses: 5, points: 18, form: 'WLWLW' },
    { rank: 5, teamId: TEAMS.hullKR.id, teamName: TEAMS.hullKR.name, teamLogoUrl: TEAMS.hullKR.logoUrl, played: 14, wins: 8, draws: 0, losses: 6, points: 16, form: 'WWLLW' },
    { rank: 6, teamId: TEAMS.salford.id, teamName: TEAMS.salford.name, teamLogoUrl: TEAMS.salford.logoUrl, played: 14, wins: 7, draws: 0, losses: 7, points: 14, form: 'LWLWL' },
    { rank: 7, teamId: TEAMS.leeds.id, teamName: TEAMS.leeds.name, teamLogoUrl: TEAMS.leeds.logoUrl, played: 14, wins: 7, draws: 0, losses: 7, points: 14, form: 'LWWLL' },
    { rank: 8, teamId: TEAMS.leigh.id, teamName: TEAMS.leigh.name, teamLogoUrl: TEAMS.leigh.logoUrl, played: 14, wins: 6, draws: 1, losses: 7, points: 13, form: 'WDLLW' },
    { rank: 9, teamId: TEAMS.huddersfield.id, teamName: TEAMS.huddersfield.name, teamLogoUrl: TEAMS.huddersfield.logoUrl, played: 14, wins: 5, draws: 1, losses: 8, points: 11, form: 'DLLWW' },
    { rank: 10, teamId: TEAMS.castleford.id, teamName: TEAMS.castleford.name, teamLogoUrl: TEAMS.castleford.logoUrl, played: 14, wins: 3, draws: 0, losses: 11, points: 6, form: 'LLWLL' },
